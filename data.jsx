...
const DEVICES = [
  {id:'d1', name:'iPhone 15 Pro',      type:'phone',  ev:'EV‑2041', imei:'35 693803 561928 4', status:'extracted',  files:4820,  size:'182 GB', cap:'256 GB', used:71, os:'iOS 18.2',          custodian:'sam',   acquired:'Jun 2', last:'4m ago',  loc:'Field Office — Austin', encrypted:true,  serial:'F2LXK9PQ7M', color:'#0073E6', apps:48, model:'A3102 · Space Black'},
  {id:'d2', name:'MacBook Pro 16"',    type:'laptop', ev:'EV‑2038', imei:'35 209410 447120 9', status:'processing', files:38402, size:'441 GB', cap:'1 TB',   used:43, os:'macOS 15.3 Sequoia', custodian:'diego', acquired:'Jun 4', last:'12m ago', loc:'Studio NAS Intake',     encrypted:true,  serial:'C02XR4HJ1WF', color:'#475569', apps:122, model:'M3 Max · 36 GB'},
  {id:'d3', name:'Galaxy S24 Ultra',   type:'phone',  ev:'EV‑2044', imei:'35 304511 902233 6', status:'locked',     files:0,     size:'—',      cap:'512 GB', used:0,  os:'Android 14',         custodian:'priya', acquired:'Jun 5', last:'1h ago',  loc:'Evidence Locker B',     encrypted:true,  serial:'RZ8W21A3PKD', color:'#DC2626', apps:0,  model:'SM‑S928 · Titanium'},
  {id:'d4', name:'SanDisk Ultra USB',  type:'drive',  ev:'EV‑2031', imei:'35 921708 118840 2', status:'extracted',  files:1204,  size:'71 GB',  cap:'256 GB', used:28, os:'exFAT',              custodian:'maya',  acquired:'May 30',last:'2h ago',  loc:'Shared Drive Intake',   encrypted:false, serial:'SDX256‑88B2', color:'#16A34A', apps:0,  model:'256 GB · 3.2 Gen 1'},
  {id:'d5', name:'iPad Air (5th gen)', type:'tablet', ev:'EV‑2029', imei:'35 156209 774301 5', status:'extracted',  files:2611,  size:'96 GB',  cap:'128 GB', used:75, os:'iPadOS 17.6',        custodian:'noah',  acquired:'May 28',last:'5h ago',  loc:'Field Office — Denver', encrypted:true,  serial:'DMPVH2K4Q1', color:'#0073E6', apps:36, model:'A2589 · Wi‑Fi'},
  {id:'d6', name:'Dell Latitude 7440', type:'laptop', ev:'EV‑2025', imei:'35 481207 660199 3', status:'review',     files:51203, size:'612 GB', cap:'1 TB',   used:60, os:'Windows 11 Pro',     custodian:'aria',  acquired:'May 26',last:'1d ago',  loc:'Studio NAS Intake',     encrypted:false, serial:'7K2LMN0093', color:'#B5851C', apps:204, model:'i7‑1365U · 32 GB'},
  {id:'d7', name:'Seagate Backup HDD', type:'drive',  ev:'EV‑2018', imei:'35 819004 233077 8', status:'extracted',  files:18950, size:'1.8 TB', cap:'4 TB',   used:46, os:'NTFS',               custodian:'lena',  acquired:'May 22',last:'2d ago',  loc:'On‑prem Archive',       encrypted:true,  serial:'NA9F3KX7TT', color:'#1D3557', apps:0,  model:'4 TB · USB 3.0'},
  {id:'d8', name:'Pixel 8 Pro',        type:'phone',  ev:'EV‑2012', imei:'35 397706 401882 1', status:'extracted',  files:3344,  size:'108 GB', cap:'128 GB', used:84, os:'Android 14',         custodian:'tyler', acquired:'May 20',last:'3d ago',  loc:'Field Office — SF',     encrypted:true,  serial:'GP8P2024XQ', color:'#0EA5E9', apps:41, model:'GA04..  · Obsidian'},
];
